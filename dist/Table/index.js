...
const Table = ({ headings, rows, isSkeleton, skeletonRows = 5, skeletonHeight = "20px", variant, size, headingReplace, }) => {
    ...
    return (React.createElement(react_1.Box, { position: "relative" },
        ...
        React.createElement(react_1.Table, { size: size },
            ...
            React.createElement(react_1.Tbody, null, isSkeleton ? (skeletonArray.map((index) => (React.createElement(react_1.Tr, { key: index }, headings.map((heading, index) => (React.createElement(react_1.Td, { key: index },
                React.createElement(react_1.Skeleton, { height: skeletonHeight })))))))) : (React.createElement(React.Fragment, null, rows.map((row, index) => {
