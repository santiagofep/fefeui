...
const Page = ({ title, description, children, maxWidth = "container.xl", onGoBack, actions, }) => {
    return (React.createElement(react_1.Container, { maxWidth: maxWidth },
        React.createElement(react_1.VStack, { align: "stretch" },
            React.createElement(react_1.Flex, { alignItems: "center", justifyContent: "space-between" },
                React.createElement(react_1.Flex, { alignItems: "center" },
                    onGoBack && (React.createElement(react_1.IconButton, { "aria-label": "Go back", onClick: onGoBack, marginRight: "0.5rem", size: "sm" },
                        React.createElement(md_1.MdArrowBack, null))),
                    React.createElement(react_1.Heading, { size: "lg" }, title)),
                React.createElement(react_1.Box, null, actions && actions)),
