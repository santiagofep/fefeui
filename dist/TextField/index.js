...
const TextField = ({ label, placeholder, value, onChange, type, helperText, isSkeleton, required, isInvalid, }) => {
    return (React.createElement(react_1.Skeleton, { isLoaded: !isSkeleton },
        React.createElement(react_1.FormControl, null,
            ...
            React.createElement(react_1.Input, { value: value, onChange: (e) => {
                ...
                }, type: type, placeholder: placeholder, required: required, isInvalid: isInvalid }),
